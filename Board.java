			...
			//THEN: No Jump Has Been Found
				...
				//THEN: Square following the move is on the board
					...
					if((board[m.getEnd().getRow()+(m.getEnd().getRow()-m.getStart().getRow())][m.getEnd().getColumn()+(m.getEnd().getColumn()-m.getStart().getColumn())].isOccupied() == false ||
					   ...
					   ((m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow()) >= 0 && m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow()) <= 7) &&
 					    (board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].isOccupied() == false || 
					     board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].getOccupyingChecker().getColor() == m.getChecker().getColor() ||
					     ((m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) >= 0 && m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) <= 7) &&
					      board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].isOccupied() &&
					      board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].isOccupied()) || 
					     ((m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) >= 0 && m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) <= 7) &&
					      board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].getOccupyingChecker().getMoveDirection() * (m.getEnd().getRow()-m.getStart().getRow()) < 0) &&
					      board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].getOccupyingChecker().isKing() == false)) && 
					   ((m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) >= 0 && m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) <= 7) &&
						 (board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].isOccupied() == false ||
						  board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].getOccupyingChecker().getColor() == m.getChecker().getColor()) || 
					      ((m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) >= 0 && m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) <= 7) &&
					       board[m.getStart().getRow()+(2 * m.getEnd().getRow()-m.getStart().getRow())][m.getStart().getColumn()].isOccupied() && 
					       board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].isOccupied()) || 
					      ((m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) >= 0 && m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn()) <= 7) &&
					       board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].getOccupyingChecker().getMoveDirection() * (m.getEnd().getRow()-m.getStart().getRow()) < 0 &&
					       board[m.getStart().getRow()][m.getStart().getColumn()+(2 * m.getEnd().getColumn()-m.getStart().getColumn())].getOccupyingChecker().isKing() == false))) {
					//THEN: Does Not Give Opponent A Jump
